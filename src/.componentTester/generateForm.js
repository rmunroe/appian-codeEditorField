...
componentDescriptor = [{"name":["readOnly"],"category":["input-only"],"type":["Boolean"]},{"name":["marginBelow"],"category":["input-only"],"type":[{"enum":[{"choice":["NONE","STANDARD"]}]}]},{"name":["fontSize"],"category":["input-only"],"type":[{"enum":[{"choice":["12","13","14","16","18","22","24"]}]}]},{"name":["hideGutter"],"category":["input-only"],"type":["Boolean"]},{"name":["hideLineNumbers"],"category":["input-only"],"type":["Boolean"]},{"name":["disableCodeFolding"],"category":["input-only"],"type":["Boolean"]},{"name":["showPrintMargin"],"category":["input-only"],"type":["Boolean"]},{"name":["printMarginColumn"],"category":["input-only"],"type":["Integer"]},{"name":["tabSize"],"category":["input-only"],"type":["Integer"]},{"name":["text"],"category":["input-output"],"type":["Text"]},{"name":["mode"],"category":["input-only"],"type":[{"enum":[{"choice":["abap","abc","actionscript","ada","alda","apache_conf","apex","aql","asciidoc","asl","assembly_x86","autohotkey","batchfile","c9search","c_cpp","cirru","clojure","cobol","coffee","coldfusion","crystal","csharp","csound_document","csound_orchestra","csound_score","css","curly","d","dart","diff","django","dockerfile","dot","drools","edifact","eiffel","ejs","elixir","elm","erlang","forth","fortran","fsharp","fsl","ftl","gcode","gherkin","gitignore","glsl","gobstones","golang","graphqlschema","groovy","haml","handlebars","haskell","haskell_cabal","haxe","hjson","html","html_elixir","html_ruby","ini","io","jack","jade","java","javascript","json5","json","jsoniq","jsp","jssm","jsx","julia","kotlin","latex","less","liquid","lisp","livescript","logiql","lsl","lua","luapage","lucene","makefile","markdown","mask","matlab","maze","mediawiki","mel","mixal","mushcode","mysql","nginx","nim","nix","nsis","nunjucks","objectivec","ocaml","pascal","perl6","perl","pgsql","php","php_laravel_blade","pig","powershell","praat","prisma","prolog","properties","protobuf","puppet","python","qml","r","razor","rdoc","red","rhtml","rst","ruby","rust","sass","scad","scala","scheme","scss","sh","sjs","slim","smarty","snippets","soy_template","space","sql","sqlserver","stylus","svg","swift","tcl","terraform","tex","text","textile","toml","tsx","twig","typescript","vala","vbscript","velocity","verilog","vhdl","visualforce","wollok","xml","xquery","yaml","zeek"]}]}]},{"name":["theme"],"category":["input-only"],"type":[{"enum":[{"choice":["ambiance","chaos","chrome","clouds","clouds_midnight","cobalt","crimson_editor","dawn","dracula","dreamweaver","eclipse","github","gob","gruvbox","idle_fingers","iplastic","katzenmilch","kr_theme","kuroir","merbivore","merbivore_soft","mono_industrial","monokai","nord_dark","pastel_on_dark","solarized_dark","solarized_light","sqlserver","terminal","textmate","tomorrow","tomorrow_night","tomorrow_night_blue","tomorrow_night_bright","tomorrow_night_eighties","twilight","vibrant_ink","xcode"]}]}]}];
